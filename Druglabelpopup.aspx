<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Druglabelpopup.aspx.cs" Inherits="Druglabelpopup" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/jscript">
        ...
        function closepopup() {
           ...
           // window.open('Druglabelpopup.aspx', 'search', 'menubar=no,center:yes,scrollbars=no,width=620,height=500[color=blue]40,top=100,left=200')
            window.close();
        }
...
<body style="background-color:#D2FECF">
    <form id="form1" runat="server" style="background-color:#D2FECF">
     ...
     <table  cellpadding="0" cellspacing="0" border="0" style="border: thin outset #C0C0C0">
     <tr>
...
<%--      <asp:Button ID="btnclear" runat="server" Text="Clear" Height="22px" CssClass="btn" 
       onclick="btnclear_Click" Width="50px" UseSubmitBehavior="False"/>--%>
...
<%--     <asp:Button ID="btnsearch" runat="server" Text="Search" Height="22px" CssClass="btn" 
     ...
     <tr>
     <td align="left">
      <asp:GridView ID="Druglabelgrid" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
        ...
        RowStyle-VerticalAlign="Middle" EnableModelValidation="True" 
             onrowdatabound="Druglabelgrid_RowDataBound" AllowPaging="True" 
             onpageindexchanging="Druglabelgrid_PageIndexChanging" 
             onrowcommand="Druglabelgrid_RowCommand" CssClass="gridcss" >  
